...
const skills = ["Python", "SQL", "Power BI", "LangChain", "OpenAI API", "RAG", "Prompt Engineering", "AI Automation"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Data Analyst", "AI Engineer", "Gen AI Developer", "Machine Learning Enthusiast", "Data & AI Specialist", "Python Developer"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Passionate Data Analyst & Gen AI Enthusiast with a strong interest in
            transforming data into powerful insights and intelligent solutions.
            Skilled in Python, SQL, Power BI, Machine Learning, and AI-driven technologies.
          </p>
        </motion.div>
