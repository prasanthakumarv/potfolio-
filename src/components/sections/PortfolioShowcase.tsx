...
{activeTab === 'techstack' && (() => {
  const skills = [
    ...
    { name: 'Prompt Eng.',       logo: 'https://cdn.simpleicons.org/openai/a78bfa' },
    { name: 'RAG',               logo: 'https://cdn.simpleicons.org/pinecone/61D8A4' },
    { name: 'AI Automation',     logo: 'https://cdn.simpleicons.org/zapier/FF4A00' },
        ...
        {skills.map((item, index) => (
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              <img src={item.logo} alt={item.name} className="relative z-10 w-[56px] h-[56px] object-contain" />
            </div>
