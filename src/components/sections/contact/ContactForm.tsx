...
const socialLinks = [
  {
    title: 'GitHub',
    user: '@prasanthakumarv',
    icon: FaGithub,
    link: 'https://github.com/prasanthakumarv',
  },
  {
    title: 'Gmail',
    user: 'Prasanthakumar.v22',
    icon: FaEnvelope,
    link: 'mailto:Prasanthakumar.v22@gmail.com',
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-white/10 pt-5 mt-6">
        ...
        {/* LINKEDIN */} 
        <motion.a
          href="https://www.linkedin.com/in/prasantha-kumar-v-9546aa3b9"  
          target="_blank"
